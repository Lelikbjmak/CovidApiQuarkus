...
public class MaxMinCovidDetailsEvaluatorServiceImpl implements MaxMinCovidDetailsEvaluatorService {
    ...
    private final CountryCovidDetailsRedisService countryCovidDetailsRedisService;
    ...
    public MaxMinCovidDetailsDto getCovidDetailsForToday(List<String> countryNameList) {
        ...
        List<CountryCovidDetailsDto> presentedInDatabaseCovidDetailsList = countryCovidDetailsRedisService.findByIdList(requestedCovidDetailsIdList);
        ...
        notPresentedInDatabaseCovidDetails.forEach(countryCovidDetailsDto ->
                countryCovidDetailsRedisService.save(covidDetailsMapper.mapToEntity(countryCovidDetailsDto)));
